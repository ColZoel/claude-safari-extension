...
`<AppGroupContainer>/claude-mcp-browser-bridge/<pid>.sock` — socket lives in the App Group container (`group.com.anthropic.claude-in-safari`) for App Sandbox compatibility; must match Claude Code CLI expectations
